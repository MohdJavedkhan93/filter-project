...
const Header = ({ onRemoveCartItems, clearCart }) => {
  ...
  const redirectToCheckout = (e, data) => {
    e.preventDefault();
  ...
  const displayCartItems = () => {
    return carts.map((cart) => {
      return (
        <div
          className="cart-item d-flex justify-content-between text-capitalize my-3"
          key={cart.id}
        >
          <img
            src={require(`../assets/img/${cart.image}`)}
            className="img-fluid"
            id="item-img"
            alt={cart.title}
            width="80"
          ...
          <div className="item-text">
            ...
            <p id="cart-item-price" className="mb-0">
              {cart.price}
            </p>
          </div>
          <a
      ...
      <nav className="navbar navbar-expand-lg px-4">
        ...
        <div className="collapse navbar-collapse" id="myNav">
          ...
          <div className="nav-info-items d-none d-lg-flex position-relative ">
            ...
            <div
              id="cart-info"
              className="nav-info align-items-center cart-info d-flex justify-content-between ms-lg-5"
              onClick={cartOpen}
            >
              ...
              <p className="mb-0 text-capitalize">
                <span id="item-count">{carts.length} </span>{" "}
            ...
            <div id="cart" className="cart position-absolute">
              ...
              <div className="cart-buttons-container mt-3 d-flex justify-content-between">
                ...
                <a
                  ...
                  onClick={(event) => {
                    redirectToCheckout(event, carts);
                  }}
                >
                  checkout
                </a>
